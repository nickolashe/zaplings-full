...
urlpatterns = patterns('',
    ...
    url(r'^creation-process/?$', views.CreationProcessView.as_view(), name='creation-process'),
    url(r'^creation-stages/?$', views.CreationStagesView.as_view(), name='creation-stages'),
    url(r'^our-mission/?$', views.MissionView.as_view(), name='our-mission'),
    url(r'^our-dream/?$', views.DreamView.as_view(), name='our-dream'),
    ...
    url(r'^new-idea/$', views.NewIdeaView.as_view(), name='new-idea'),
